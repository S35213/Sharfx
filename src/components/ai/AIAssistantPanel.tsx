...
export function AIAssistantPanel({ symbol, timeframe, candles, setup = null, onReviewSetup }: Props) {
  ...
  const activityMessages = [
    'Reading the latest candle structure…',
    'Checking nearby liquidity and key levels…',
    'Comparing momentum with the surrounding timeframes…',
    'Testing the current setup against invalidation…',
  ]
  ...
  return (
    <div className="space-y-3 rounded-lg border border-shafx-border bg-shafx-surface p-4 text-sm">
      ...
      <div className="rounded-xl border border-shafx-accent/20 bg-shafx-bg p-3">
        ...
        <div className="mt-3 rounded-lg border border-shafx-border bg-shafx-surface px-2.5 py-2 font-mono text-[9px] text-shafx-text">
          <span className="text-shafx-accent">agent&gt;</span> {activityMessages[activityIndex]}
