...
export function TradingAgentPanel({
  ...
  useEffect(() => {
    ...
    <section className="rounded-2xl border border-shafx-border bg-shafx-surface p-3.5 text-sm shadow-[0_14px_36px_rgba(0,0,0,.18)] sm:p-4">
      <header className="flex items-start justify-between gap-3">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-[10px] text-shafx-textMuted">Automatic simulated trading with a simple control panel.</p>
          </div>
        </div>
      ...
      <div className="mt-3 grid grid-cols-3 gap-2 text-[9px]"><div className="rounded-xl border border-shafx-border bg-shafx-bg px-2.5 py-2.5"><span className="block text-shafx-textMuted">Won</span><strong className="mt-0.5 block font-mono text-shafx-success">{wins}</strong></div><div className="rounded-xl border border-shafx-border bg-shafx-bg px-2.5 py-2.5"><span className="block text-shafx-textMuted">Lost</span><strong className="mt-0.5 block font-mono text-shafx-danger">{losses}</strong></div><div className="rounded-xl border border-shafx-border bg-shafx-bg px-2.5 py-2.5"><span className="block text-shafx-textMuted">Units</span><strong className="mt-0.5 block font-mono text-shafx-text">{cycleUnits}/{plan.maxDailyCycleUnits === null ? '∞' : plan.maxDailyCycleUnits}</strong></div></div>
