...
const TerminalContent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const load = async (): Promise<void> => {
      ...
      if (cancelled) return
      setWatchlist(wl); setAccountData(acc); setSymbolSpec(spec); setCandles(cands); setMarketAnalysis(ma); setAiAnalysis(ai); setOpenPositions(positions); setPendingOrders(pending); setTradeHistory(history)
