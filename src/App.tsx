...
const TerminalContent: React.FC = () => {
  ...
  return <div className="flex h-full flex-col overflow-hidden bg-shafx-bg text-shafx-text">
    ...
    <main className="flex flex-1 flex-col overflow-y-auto pb-16 lg:flex-row lg:overflow-hidden lg:pb-0">
      <aside className="hidden w-56 flex-shrink-0 flex-col gap-4 border-r border-shafx-border p-3 lg:flex lg:overflow-y-auto">
        <div className="h-72 flex-shrink-0"><Watchlist pairs={watchlist} selectedPair={selectedSymbol} onSelectPair={setSelectedSymbol} /></div>
