...
describe('Market Structure Engine', () => {
  ...
  it('detects bullish HH/HL structure', () => {
    ...
    expect(result.swingHighs[result.swingHighs.length - 1]?.label).toBe('HH')
    expect(result.swingLows[result.swingLows.length - 1]?.label).toBe('HL')
  })
  it('detects bearish LH/LL structure', () => {
    ...
    expect(result.swingHighs[result.swingHighs.length - 1]?.label).toBe('LH')
    expect(result.swingLows[result.swingLows.length - 1]?.label).toBe('LL')
  })
